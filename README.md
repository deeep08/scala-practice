# scala-practice
Repository to practice and learn Scala

This repository contains the solution of the problems in http://aperiodic.net/phil/scala/s-99/

The web page has been copied here for quick reference. Thanks to aperiodic.net
